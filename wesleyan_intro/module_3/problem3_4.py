...
def problem3_4(month, day, year):
    ...
    output = months[month]+'/'+str(day)+'/'+str(year)
    print(output)
    

def test4():
      problem3_4("January",17, 2016)
      problem3_4("February",17, 2016)
      problem3_4("March",17, 2016)
      problem3_4("April",17, 2016)
      problem3_4("May",17, 2016)
      problem3_4("June",17, 2016)
      problem3_4("July",17, 2016)
      problem3_4("August",17, 2016)
      problem3_4("September",17, 2016)
      problem3_4("October",17, 2016)
      problem3_4("November",17, 2016)
      problem3_4("December",17, 2016)
