...
def problem2_4():
    ...
    reals = []
    while count < 10:
        reals.append(30 + random.random()*5)
        count +=1
    print(reals)
...
def problem2_7():
    ...
    floats = []
    for side in sides:
        if side and side.isdigit():
            floats.append(float(side))
        else:
            pass
        
    s = 0    
    if len(floats) == 3:
        s = 0.5 * (floats[0] + floats[1] + floats[2])
    
    if s != 0:
        area = (s * (s-floats[0]) * (s-floats[1]) * (s-floats[2]))**.5
        print('Area of a triangle with sides',floats[0],floats[1],floats[2],'is',area)
    else:
        pass
...
low_temp = [40.0, -39.0, 37.0, 34.0, 33.0, 34.0, 36.0, 37.0, 38.0, 39.0, \
               40.0, 41.0, 44.0, 45.0, 47.0, 48.0, 45.0, 42.0, 39.0, 37.0, \
               36.0, 35.0, 33.0, 32.0]
