...
but its presence doesn't affect how your code runs. 
"""
"""
IMPORTANT TIPS:
...
def problem1_7():
    ...
    b1 is the length of one of the bases, b2 the other. 
    The height is h and the area is A.
    """
    b1 = b2 = h = ''
    ...
    a = input('Enter the length of the other base: ')
    if is_numeric_string(a):
        b2 = float(a)
